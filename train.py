...
training_set = train_datagen.flow_from_directory(r'C:\Users\Mithun\OneDrive\Desktop\SOURCE CODE/dataset',
                                                 target_size=(100, 100),
                                                 batch_size=64,
                                                 class_mode='binary')

test_set = test_datagen.flow_from_directory(r'C:\Users\Mithun\OneDrive\Desktop\SOURCE CODE/dataset',
                                            target_size=(100, 100),
                                            batch_size=64,
                                            class_mode='binary')
my_callbacks = [
